  ...
  const save = (i: number, form: HTMLFormElement) => {
    ...
    start(async () => {
      ...
      if (res.error) patch(i, { _error: res.error });
        ...
        pct_time_in_sales: Number(fd.get("pct_time_in_sales") || 0), pct_shareholding: Number(fd.get("pct_shareholding") || 0), annual_salary: Number(String(fd.get("annual_salary") ?? "0").replace(/[^0-9.]/g, "") || 0) });
    });
  };
