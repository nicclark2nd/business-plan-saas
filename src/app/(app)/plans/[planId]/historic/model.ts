...
export const BS_LINES: LineDef[] = [
  ...
  { field: "prepayments", label: "Prepayments", help: "Paid in advance and not yet used at period end \u2014 insurance, rent, registrations. This opens the forecast's prepaid balance, so a prepayment you already carry costs nothing to start. If you have been including it in Other current assets, take it out of there." },
  ...
  { field: "accruals", label: "Accruals", help: "Incurred and not yet billed to you at period end. This opens the forecast's accrued balance. If you have been including it in Other current liabilities, take it out of there." },
