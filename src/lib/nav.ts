/** Left-menu model. Guided mode shows the numbered 14-step path plus tools; Advanced shows every module. */
...
export const NAV: NavGroup[] = [
  ...
  { group: "Goals", items: [{ id: "swot", label: "SWOT", step: 5 }, { id: "goals", label: "Goals", step: 13, tag: "AI-drafted" }] },
  ...
  { group: "Forecasts", items: [
    { id: "forecast", label: "Review forecast", step: 12, advancedLabel: "Profit & Loss" },
  ...
  { group: "Reports", items: [{ id: "reports", label: "Business plan", step: 14, tool: true }] },
